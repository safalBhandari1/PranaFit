...
//       component: SafeAreaWrapper(HomeScreen), // ✅ NEW - Direct HomeScreen
...
import ProjectStackNavigator from './ProjectStackNavigation';
import HomeScreen from '../../features/home/components/HomeScreen';
import ReportDetailScreen from '../../features/home/components/ReportDetailScreen'; // 🚀 IMPORT
import { ProfileScreen } from '../../features/profile/components/ProfileScreen';
...
const Tab = createBottomTabNavigator();
const HomeStack = createNativeStackNavigator(); // 🚀 CREATE STACK
...
export default function TabNavigator() {
  ...
  const isGymBusinessUser = 
    (isGymOwner || isGymStaff || isGymTrainer) ||
    (isGymOwnerGlobal || isGymStaffGlobal || isGymTrainerGlobal);
  ...
  // 🚀 UPDATE: Use HomeStackNavigator instead of HomeScreen
  const memberTabs = [
    { 
      name: 'Home', 
      component: SafeAreaWrapper(HomeStackNavigator), // 🚀 USE STACK
      icon: (focused: boolean) => focused ? 'home' : 'home-outline',
      label: 'Home'
    },
    { 

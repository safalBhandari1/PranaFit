// // src/features/profile/components/GymSwitcherModal.tsx
...
//         // In a real app, you would fetch gym details from your service
...
//             gymsList.push({
//               id: gymId,
//               name: `Gym ${gymId.slice(0, 8)}...`, // Placeholder - would fetch actual name
//               role,
...
//       Alert.alert(
//         '✅ Gym Switched',
//         'Successfully switched to the selected gym.',
//         [{ text: 'OK' }]
//       );
//     } catch (error: any) {
...
//         <ThemeText style={styles.gymItemName}>
//           {item.name}
//         </ThemeText>
//         <ThemeText style={styles.gymItemRole}>
...
//       {isLoading && item.id === currentGymId && (
